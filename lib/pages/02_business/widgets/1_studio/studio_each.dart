        ...
        child: Column(
          ...
          children: [
            ...
            _StudioItem(
              ...
              imgPath: 'assets/img/business/studio_one.webp',
              isDesktop: true,
            ),
            _StudioItem(
              title: '블랙 스튜디오',
              content: '무게감 있는 블랙 배경을 통해, 자막을 강조하고 집중도 있는 교육 콘텐츠 제작에 유용한 스튜디오',
              imgPath: 'assets/img/business/studio_black.webp',
              isDesktop: true,
            ),
            _StudioItem(
              title: '화이트 스튜디오',
              content: '피사체에 균일한 광량을 제공, 강의자에게 초점을 맞춘 고품질 콘텐츠를 제작할 수 있는 스튜디오',
              imgPath: 'assets/img/business/studio_white.webp',
              isDesktop: true,
            ),
            _StudioItem(
              title: '크로마키 스튜디오',
              content: '가상 배경 합성을 통해 다채로운 교육 콘텐츠를 제작할 수 있는 스튜디오',
              imgPath: 'assets/img/business/studio_chroma.webp',
              isDesktop: true,
            ),
            SizedBox(height: 25),
          ],
